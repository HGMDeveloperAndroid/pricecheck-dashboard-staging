...
export default class GraphTabCompare extends Component<Props> {
    static defaultProps = {
        priceField: 'price'
    }
        ...
        try {
            ...
            const requestOptions = {
                ...
                params: {
                    ...
                    barcodes: window.location.href.split('?barcodes=')[1],
                }
            };
            ...
            if (response.status === 200) {
                ...
                datasets = datasetCollection.map(item => this.parseDataset(item));
                this.setState({
                    labels,
                    datasets
                });
    ...
    getChart = () => {
        return (
            <div className={s.graphContainer}>
                <Line height={100} data={this.state} options={this.tooltipOptions} />
            </div>
        )
    }
